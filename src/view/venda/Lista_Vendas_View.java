 ...
 */
public class Lista_Vendas_View extends javax.swing.JDialog {

    /**
     * Creates new form Lista_Compras_View
     */
    public Lista_Vendas_View(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        jdcAte.setDate(new Date());
        jdcDe.setDate(new Date());
        popularTabelaVendas(jdcDe.getDate(), jdcAte.getDate(), (String) jcbbStatus.getSelectedItem());
    }

    public void popularTabelaVendas(Date dataIni, Date dataFim, String status) {
        SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy");
        Venda_Controller vc = new Venda_Controller();
        Pagamento_Venda_Controller pvc = new Pagamento_Venda_Controller();
        List<Venda_Model> lista = vc.pesquisaVendaDataStatus(dataIni, dataFim, (String) jcbbStatus.getSelectedItem());
        ...
        lista.forEach((vm) -> {
            ...
            dtm.addRow(new Object[]{vm.getNumVenda(),
                df.format(vm.getDataVenda()),
                String.format("%.2f", vm.getValorComDesconto()), vm.getStatusVenda()});
    ...
    private void initComponents() {
        ...
        jcbbStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Em Aberto", "Finalizada", "Cancelada" }));
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        Listagem_Clientes_Venda_View lc = new Listagem_Clientes_Venda_View(null, true);
        lc.setVisible(true);
        popularTabelaVendas(jdcDe.getDate(), jdcAte.getDate(), (String) jcbbStatus.getSelectedItem());
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        if (jtDados.getSelectedRow() < 0) {
            ...
            Venda_Controller cc = new Venda_Controller();
            Venda_Model cm;
            int linha = jtDados.getSelectedRow();
            List<Venda_Model> lista = cc.pesquisaVendaDataStatus(jdcDe.getDate(), jdcAte.getDate(), (String) jcbbStatus.getSelectedItem());
            cm = lista.get(linha);
            NovaVenda_View nvv = new NovaVenda_View(null, true, cm);
            nvv.setVisible(true);
        }
        popularTabelaVendas(jdcDe.getDate(), jdcAte.getDate(), (String) jcbbStatus.getSelectedItem());
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        if (jtDados.getSelectedRow() < 0) {
            ...
            int confirmacao = JOptionPane.showConfirmDialog(rootPane, "Deseja Cancelar esta Venda?");
            if (confirmacao == JOptionPane.YES_OPTION) {
                Venda_Controller vc = new Venda_Controller();

                Venda_Model vm;
                int linha = jtDados.getSelectedRow();
                List<Venda_Model> lista = vc.pesquisaVendaDataStatus(jdcDe.getDate(), jdcAte.getDate(), (String) jcbbStatus.getSelectedItem());
                vm = lista.get(linha);
    ...
    private void btnVisualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVisualizarActionPerformed
        if (jtDados.getSelectedRow() < 0) {
            JOptionPane.showMessageDialog(null, "Selecione uma venda na tabela para executar esta ação!");
        } else {
            Venda_Controller cc = new Venda_Controller();
            Venda_Model cm;
            int linha = jtDados.getSelectedRow();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lista_Vendas_View.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Lista_Vendas_View dialog = new Lista_Vendas_View(new javax.swing.JFrame(), true);
