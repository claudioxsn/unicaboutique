 ...
 */
public class Lista_Produtos_Condicional_View extends javax.swing.JDialog {

    /**
     * Creates new form Lista_Produtos_Condicional_View
     */
    public Lista_Produtos_Condicional_View(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public Lista_Produtos_Condicional_View(java.awt.Frame parent, boolean modal, Condicional_Model vm) {
        super(parent, modal);
        initComponents();
        vMod = vm;
    }

    Condicional_Model vMod;
    ...
    public void selecionarProduto(int linha) {
        ...
        Itens_Condicional ivm = new Itens_Condicional();
        Produto_Model pm;
        ...
        if (pm.getQtdEstoque() < 1) {
            ...
            ivm.setCondicional(vMod);
            ivm.setProduto(pm);
            dispose();
            Dados_Item_Condicional_View dic = new Dados_Item_Condicional_View(null, true, ivm);
            dic.setVisible(true);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lista_Produtos_Condicional_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Lista_Produtos_Condicional_View dialog = new Lista_Produtos_Condicional_View(new javax.swing.JFrame(), true);
