 ...
 */
public final class Lista_Cliente_View extends javax.swing.JDialog {

    /**
     * Creates new form Lista_Cliente_View
     */
    public Lista_Cliente_View(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void popularTabelaTodosClientes() {
        ...
        List<Cliente_Model> lista = cc.listarTodos();
        ...
        lista.forEach((cm) -> {
            dtm.addRow(new Object[]{cm.getNome(), cm.getCpf(), cm.getRg(), cm.getTelefoneResidencial(), cm.getWhatsApp()});
        });
    }
    ...
    public void selecionarCliente(int linha) {
        Cliente_Controller cc = new Cliente_Controller();
        Cliente_Model cm;
        List<Cliente_Model> lista;
        lista = cc.pesquisarPorNome(tfPesquisa.getText());
        cm = lista.get(linha);
        Cadastro_Cliente_View ccv = new Cadastro_Cliente_View(null, true, cm);
        ccv.setVisible(true);
    }
    ...
    public void popularTabelaPesquisaCpf(String pesquisa) {
        Cliente_Controller cc = new Cliente_Controller();
        List<Cliente_Model> lista = cc.pesquisarPorCpf(pesquisa);
        DefaultTableModel dtm = (DefaultTableModel) jtDados.getModel();
        while (dtm.getRowCount() > 0) {
            dtm.removeRow(0);
        }
    ...
    private void initComponents() {
        ...
        setTitle("UnicaBoutique - Formulário de Listagem de Clientes");
        setResizable(false);
        ...
        tfPesquisa.setToolTipText("Informe o nome do cliente neste campo para efetuar a pesquisa");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tfPesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 284, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/1499301286_Purse.png"))); // NOI18N
        jButton1.setText("Débitos");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        lista = cc.pesquisarPorNome(tfPesquisa.getText());
        cm = lista.get(linha);
        if (cc.verificaPresencaClienteVenda(cm).isEmpty()) {
            if (jtDados.getSelectedRow() < 0) {
                ...
                if (confirmacao == JOptionPane.YES_OPTION) {
                    cc.excluirDados(cm.getId());
                }
            }
        } else {
            JOptionPane.showMessageDialog(null, "O cadastro não pode ser excluído pois possui vendas/OS relacionadas no sistema");
        }
        popularTabelaPesquisaNome(tfPesquisa.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jtDados.getSelectedRow() < 0) {
            JOptionPane.showMessageDialog(null, "Selecione um cliente na tabela para executar esta ação!!");
        } else {
            int linha = jtDados.getSelectedRow();
            ...
            lista = cc.pesquisarPorNome(tfPesquisa.getText());
            cm = lista.get(linha);
            DebitosCliente_View dcv = new DebitosCliente_View(null, true, cm);
            dcv.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lista_Cliente_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Lista_Cliente_View dialog = new Lista_Cliente_View(new javax.swing.JFrame(), true);
